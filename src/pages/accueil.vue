<template>
  ...
  <div>
    <main>
      <div class="accueil">
        <img src="../img/fondu.png" id="accueil" alt="fondu">
        <div class="titre">
      ...
      <div class="presentation">
        <img src="../img/accueil.png" alt="Présentation" id="presentation">
        <p>Lady Gaga est une star planétaire ainsi qu'une actrice
          récompensée aux oscars. Entre pop, rock, jazz et dance, son
          univers décalé a su conquérir de nombreux fans, ainsi que le
          grand public.

          Cette artiste possède à son compteur 8 albums et 2 films au
          cinéma.

          Découvrez en plus sur Lady Gaga, artiste aux multiples talents. </p>
      </div>
      <div class="liens">
        <div class="biographie">
          <router-link to="/biographie">
            <img src="../img/bio.png" alt="Biographie">
            <h2>Biographie</h2>
          </router-link>
        </div>
        <div class="filmographie">
          <router-link to="/filmographie">
          <img src="../img/star_is_born.png" alt="Filmographie">
          <h2>Filmographie</h2>
          </router-link>
        </div>
        <div class="discographie">
          <router-link to="/discographie">
          <img src="../img/the_fame.png" alt="Discographie">
          <h2>Discographie</h2>
          </router-link>
        </div>
      </div>

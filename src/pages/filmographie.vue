<template>
  ...
  <div>
    ...
    <main>
      <div class="accueil">
        <img src="../img/star_is_born_film.png" id="accueil" alt="Films">
        <div class="titre">
      ...
      <div class="filmographie">
        <div class="films-item" v-for="film in films" :key="films.id">
          <img :src="film.image_film" alt="film.nom">
          <div>
            <p> {{ film.nom }} <br> Sortie en {{ film.annee }}</p>
          </div>
        </div>
